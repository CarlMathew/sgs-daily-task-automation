        ...
        for site in sites:
            ...
            if site == "Scott":
                ...
                if len(validated_files) != 0:
                    ...
                    pipeline.pipeline_for_worklist(validated_files, Config.Scott().yesterday_report_path, Config.Scott().qa_samples, worklist.Scott, Config.Scott().counting_data, site)
            ...
            if site == "Wheat Ridge":
                ...
                if len(validated_files) != 0:
                    ...
                    logger.info("Cleaning the raw files. (Data Pipeline Running...)")
                    pipeline.pipeline_for_worklist(validated_files, Config.Wheat_Ridge().yesterday_report_path, Config.Wheat_Ridge().qa_samples, worklist.Wheat_Ridge, Config.Wheat_Ridge().counting_data, site)
            ...
            if site == "Orlando":
                ...
                if len(validated_files) != 0:
                    ...
                    logger.info("Cleaning the raw files. (Data Pipeline Running...)")
                    pipeline.pipeline_for_worklist(validated_files, Config.Orlando().yesterday_report_path, Config.Orlando().qa_samples, worklist.Orlando, Config.Orlando().counting_data, site)
